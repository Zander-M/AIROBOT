...
def main():
    ...
    ap.add_argument("--space_scale", type=float, default=1.0)
    ap.add_argument("--time_scale", type=float, default=4.0)
    ap.add_argument("--x_offset", type=float, default=-2.0)
    ap.add_argument("--y_offset", type=float, default=-2.0)
    args = ap.parse_args()
